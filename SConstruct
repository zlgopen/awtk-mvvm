...
compile_helper = helper.get_curr_config()
...
BUILD_TESTS = True
BUILD_DEMOS = True
if compile_helper.get_value('LINUX_FB', True) :
  BUILD_TOOLS = False
  BUILD_TESTS = False

os.environ['BUILD_DEMOS'] = str(compile_helper.get_value('BUILD_DEMOS', True)).lower()
os.environ['BUILD_TESTS'] = str(compile_helper.get_value('BUILD_TESTS', BUILD_TESTS)).lower()
os.environ['BUILD_TOOLS'] = str(compile_helper.get_value('BUILD_TOOLS', BUILD_TOOLS)).lower()
...
if 'WITH_JS' in os.environ and os.environ['WITH_JS'] == 'true':
  ...
  os.environ['WITH_IOTJS'] = str(compile_helper.get_value('WITH_IOTJS', True)).lower()
