...
static bool_t screensaver_view_model_can_exec(tk_object_t* obj, const char* name, const char* args) {
  ...
  if (tk_str_ieq("setTime", name)) {
    return screensaver_can_set_time(ascreensaver);
  }
  return FALSE;
}
...
static ret_t screensaver_view_model_exec(tk_object_t* obj, const char* name, const char* args) {
  ...
  screensaver_t* ascreensaver = vm->ascreensaver;
  if (tk_str_ieq("setTime", name)) {
    return screensaver_set_time(ascreensaver);
...
static const object_vtable_t s_screensaver_view_model_vtable = {
  ...
  "screensaver_view_model_t",
  sizeof(screensaver_view_model_t),
  FALSE,
  screensaver_view_model_on_destroy,
  NULL,
  screensaver_view_model_get_prop,
  screensaver_view_model_set_prop,
  NULL,
  NULL,
  screensaver_view_model_can_exec,
  screensaver_view_model_exec
};
