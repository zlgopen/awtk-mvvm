...
COMPILE_CONFIG = {
  ...
  'BUILD_TESTS' : { 'value' : None, 'desc' : ['build awtk\'s mvvm\'s gtest demo'], 'help_info' : 'build awtk\'s mvvm\'s gtest demo, value is true or false' },
  'BUILD_DEMOS' : { 'value' : None, 'desc' : ['build awtk\'s mvvm\'s demo examples'], 'help_info' : 'build awtk\'s mvvm\'s demo examples, value is true or false' },
  'BUILD_TOOLS' : { 'value' : None, 'desc' : ['build awtk\'s mvvm\'s tools'], 'help_info' : 'build awtk\'s mvvm\'s tools, value is true or false' },
